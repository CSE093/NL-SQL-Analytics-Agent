# ==========================================
# SYSTEM & USER PROMPTS FOR ANALYTICSGPT
# ==========================================

SQL_GENERATION_SYSTEM_PROMPT = """You are a SQLite expert database analyst.
...
SQL_REFINER_SYSTEM_PROMPT = """You are a SQLite expert database debugger.
...
SQL_REFINER_USER_PROMPT_TEMPLATE = """Please review the failed query and error message, then output the corrected SQLite SELECT query within a ```sql ... ``` block to answer: "{question}"."""
